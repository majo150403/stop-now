...
<head>
   ...
   <!-- Tell the browser to be resposive to screen width-->
...
<div class="register-box">
   ...
   <div class="register-box-body">
      <p class="login-box-msg">Registrate en REDSOCIAL</p>

      <form action=""method="post">
         <div class="form-group has-feedback">
            <input type="text" name="nombre" class="form-control" placeholder="Nombre completo" value="<?php echo $_POST['nombre']; ?>" require>
         ...
         <div class="row">
            <div class="col-xs-10">
               <div class="checkbox icheck">
                  <label>
                     <input type="checkbox" name="check" required> Acepto los <a href="#">terminos y condiciones</a>
                  </label>
               </div>
            </div>
            <!-- /.col -->
       ...
       if(isset($_POST['registrar'])) {
          ...
          $nombre = mysql_real_scape_string($_POST['nombre']);
          $email = mysql_real_scape_string($_POST['email']);
          $usuario = mysql_real_scape_string($_POST['usuario']);
          $contrasena = mysql_real_scape_string(md5($_POST['contrasena']));
          $repcontrasena = mysql_real_scape_string(md5($_POST['repcontrasena']));
          ...
          if($comprobarusuario >= 1) { echo "El nombre de usuario esta en uso, por favor escoja otro"; } else {

            if($comprobaremail >= 1) { echo "El email ya esta en uso, por favor escoja otro o verifique si tienes una cuenta";} else {
               
               if($contrasena != $repcontrasena) { echo "Las contraseñas no coinciden";} else {
                  ...
                  if($insertar) { echo "Felicidades, se ha registrado correctamente";}
